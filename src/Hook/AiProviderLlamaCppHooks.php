...
namespace Drupal\ai_provider_llama_cpp\Hook;

use Drupal\Core\Entity\EntityInterface;
use Drupal\Core\Hook\Attribute\Hook;

/**
 * Hook implementations for ai_provider_llama_cpp.
 */
class AiProviderLlamaCppHooks {
  ...
  public static function entityDelete(EntityInterface $entity): void {
    if ($entity->getEntityTypeId() === 'llama_cpp_server') {
