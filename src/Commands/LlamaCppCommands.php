...
namespace Drupal\ai_provider_llama_cpp\Commands;
 ...
 */
class LlamaCppCommands extends DrushCommands {
   ...
   * @usage drush llama-cpp:discover-models
   *   Discover models for all configured servers.
   * @usage drush llama-cpp:discover-models my_server
  ...
  public function discoverModels(?string $server_id = NULL): void {
    ...
    if ($server_id) {
      /** @var \Drupal\ai_provider_llama_cpp\Entity\LlamaCppServerInterface|null $server */
      ...
      /** @var \Drupal\ai_provider_llama_cpp\Entity\LlamaCppServerInterface[] $servers */
